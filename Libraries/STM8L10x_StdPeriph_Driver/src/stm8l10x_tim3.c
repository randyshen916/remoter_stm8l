...
/**
  ...
  * @param[in] TIM3_Prescaler : This parameter can be any member of the @Ref TIM3_Prescaler_TypeDef enumeration.
  * @param[in] TIM3_CounterMode : This parameter can be any member of the @Ref TIM3_CounterMode_TypeDef enumeration.
  * @param[in] TIM3_Period : This parameter must be a value between 0x0000 and 0xFFFF.
  * @retval None
  */
...
/**
  ...
  * @param[in] TIM3_OCMode : This parameter can be any member of the @Ref TIM3_OCMode_TypeDef enumeration.
  * @param[in] TIM3_OutputState : This parameter can be any member of the @Ref TIM3_OutputState_TypeDef enumeration.
  * @param[in] TIM3_Pulse : This parameter must be a value between 0x0000 and 0xFFFF.
  * @param[in] TIM3_OCPolarity : This parameter can be any member of the @Ref TIM3_OCPolarity_TypeDef enumeration.
  * @param[in] TIM3_OCIdleState : This parameter can be any member of the @Ref TIM3_OCIdleState_TypeDef  enumeration.
  * @retval None
  */
...
/**
  ...
  * @param[in] TIM3_AutomaticOutput : TIM3 AOE Bit Set/Reset .
...
/**
  ...
  * @param[in] TIM3_Channel : This parameter can be any member of the @Ref TIM3_Channel_TypeDef enumeration.
  * @param[in] TIM3_ICPolarity : This parameter can be any member of the @Ref TIM3_ICPolarity_TypeDef enumeration.
  * @param[in] TIM3_ICSelection : This parameter can be any member of the @Ref TIM3_ICSelection_TypeDef enumeration.
  * @param[in] TIM3_ICPrescaler : This parameter can be any member of the @Ref TIM3_ICPSC_TypeDef enumeration.
  * @param[in] TIM3_ICFilter : This parameter must be a value between 0x00 and 0x0F.
  * @retval None
  */
...
/**
  ...
  * @param[in] TIM3_ExtTRGFilter: Specifies the External Trigger Filter.
...
/**
  ...
  * @param[in] TIM3_ICFilter : Specifies the filter value.
  * This parameter must be a value between 0x00 and 0x0F
  * @retval None
  */
...
/**
  ...
  * @param[in] TIM3_Counter : Specifies the Counter register new value.
...
/**
  ...
  * @param[in] TIM3_Autoreload : Specifies the Autoreload register new value.
  * This parameter is between 0x0000 and 0xFFFF.
  * @retval None
  */
...
/**
  ...
  * @param[in] TIM3_Compare : Specifies the Capture Compare1 register new value.
  * This parameter is between 0x0000 and 0xFFFF.
  * @retval None
  */
...
/**
  ...
  * @param[in] TIM3_Compare : Specifies the Capture Compare2 register new value.
  * This parameter is between 0x0000 and 0xFFFF.
  * @retval None
  */
...
FlagStatus TIM3_GetFlagStatus(TIM3_FLAG_TypeDef TIM3_FLAG)
{
    ...
    __IO uint8_t tim3_flag_l, tim3_flag_h;

    /* Check the parameters */
    assert_param(IS_TIM3_GET_FLAG(TIM3_FLAG));

    tim3_flag_l = (uint8_t)(TIM3_FLAG);
    tim3_flag_h = (uint8_t)((uint16_t)TIM3_FLAG >> 8);

    if (((TIM3->SR1 & tim3_flag_l) | (TIM3->SR2 & tim3_flag_h)) != 0)
    {
        bitstatus = SET;
    }
    else
